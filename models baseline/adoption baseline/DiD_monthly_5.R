...
OUT_DIR   <- file.path("result tables baseline", "adoption", "main"); dir.create(OUT_DIR, showWarnings = FALSE, recursive = TRUE)
...
run_one_series <- function(dat, y, break_date){
  ...
  ## Omit NAs from outcome, bin, and trend only (no controls)

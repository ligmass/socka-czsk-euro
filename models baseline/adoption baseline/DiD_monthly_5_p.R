...
OUT_DIR   <- file.path("result tables baseline", "adoption", "placebo_2008"); dir.create(OUT_DIR, showWarnings = FALSE, recursive = TRUE)
...
fwrite(es_main, file.path(OUT_DIR, "es_placebo_2008.csv"))
cat("\nDone. Outputs in ", OUT_DIR, ":\n- es_placebo_2008.csv (PLACEBO coefficients with GOF columns)\n", sep = "")
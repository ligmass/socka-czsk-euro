...
# ---------- write ----------
fwrite(es_main, file.path(OUT_DIR_RAW, "es_quad_trend.csv"))
export_academic_table(es_main, file.path(OUT_DIR_FINAL, "es_quad_trend_academic.csv"))
cat("\nDone. Outputs in ", OUT_DIR_RAW, ":\n- es_quad_trend.csv (Quadratic Trend coefficients with GOF columns)\n", sep = "")
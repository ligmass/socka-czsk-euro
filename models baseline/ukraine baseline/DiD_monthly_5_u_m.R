...
OUT_DIR   <- file.path("result tables baseline", "ukraine", "ukraine_mechanism"); dir.create(OUT_DIR, showWarnings = FALSE, recursive = TRUE)
...
fwrite(es_main, file.path(OUT_DIR, "es_ukraine_mechanism.csv"))

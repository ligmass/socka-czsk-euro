...
OUT_DIR   <- "tables5_covid_placebo"; dir.create(OUT_DIR, showWarnings = FALSE, recursive = TRUE)
...
run_one_series <- function(dat, y, break_date){
  ...
  ## MODIFIED: Back to the linear trend model ##
...
fwrite(gof_main, file.path(OUT_DIR, "es_crisis_covid_gof.csv"))
cat("\nDone. Outputs in ", OUT_DIR, ":\n",
    "- es_crisis_covid.csv (COVID Crisis coefficients)\n",
    "- es_crisis_covid_gof.csv (COVID Crisis fit stats)\n", sep = "")
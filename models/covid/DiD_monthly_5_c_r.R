...
OUT_DIR   <- "tables5_covid_rate_cut"; dir.create(OUT_DIR, showWarnings = FALSE, recursive = TRUE)
...
fwrite(es_main, file.path(OUT_DIR, "es_covid_no_policy.csv"))
fwrite(gof_main, file.path(OUT_DIR, "es_covid_no_policy_gof.csv"))
